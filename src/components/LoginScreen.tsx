...
interface LoginScreenProps {
  ...
  language: 'en' | 'hi' | 'pa' | 'ta'; // Added 'ta'
  setLanguage: (lang: 'en' | 'hi' | 'pa' | 'ta') => void; // Added 'ta'
}
...
export function LoginScreen({ onLogin, language }: LoginScreenProps) {
  ...
  const translations = {
    ...
    // ADDED TAMIL TRANSLATIONS HERE
    ta: {
      title: "சுகாதார தளத்தை அணுகவும்",
      ...
      pharmacy: "மருந்தகம்",
      login: "தொடரவும்",
      privacy: "உங்கள் தரவு பாதுகாப்பானது",
      demo: "டெமோ உள்நுழைவு",
      patientDesc: "ஆலோசனைகளை பதிவு செய், பதிவுகளை பார்",
      doctorDesc: "ஆலோசனைகள், மருந்து சீட்டுகளை நிர்வகி",
      pharmacyDesc: "மருந்து இருப்பு, ஆர்டர்களை புதுப்பி"
    }
  };
  ...
  const handleDemoLogin = (demoRole: 'patient' | 'doctor' | 'pharmacy') => {
    const demoUsers = {
      ...
      pharmacy: { name: 'Sitapur Medical Store', phone: '+91-98765-43212' }
    };
