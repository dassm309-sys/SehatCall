...
export function PharmacyLocator({ user, language, isOnline }: PharmacyLocatorProps) {
  ...
  const translations = {
    ...
    ta: {
      title: "மருந்தக இருப்பிடம்",
      subtitle: "அருகிலுள்ள மருந்தகங்களைக் கண்டறிந்து மருந்து இருப்பை சரிபார்க்கவும்",
      search: "மருந்து அல்லது மருந்தகத்தைத் தேடுங்கள்",
      nearbyPharmacies: "அருகிலுள்ள மருந்தகங்கள்",
      medicineAvailability: "மருந்து இருப்பு",
      directions: "வழிமுறைகளைப் பெறுக",
      call: "அழைக்கவும்",
      order: "டெலிவரிக்கு ஆர்டர் செய்யுங்கள்",
      ...
      distance: "தூரம்",
      services: "சேவைகள்",
      deliveryAvailable: "வீட்டு டெலிவரி உள்ளது",
      ...
      offlineMode: "ஆஃப்லைன் முறை - சேமிக்கப்பட்ட தரவைக் காட்டுகிறது",
            ...
            <div className="mb-4">
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder={t.search} // Use translated placeholder
                  className="pl-10"
                />
              </div>
            </div>
